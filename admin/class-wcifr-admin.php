...
class WCIFR_Admin {
	...
	public function wcifr_options() {
		...
		if ( isset( $_POST['wcifr-premium-key'], $_POST['wcifr-premium-key-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['wcifr-premium-key-nonce'] ) ), 'wcifr-premium-key' ) ) {
